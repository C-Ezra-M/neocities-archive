...
- last syllable:
    - many interjections: *hu**ra*** ("hooray")
    - initialisms: *R**P*** (*er-**pe***, "Republic of Poland")
    - unadapted borrowings from French: *faux **pas***
- 3rd syllable from the end:
    - words from classical languages:
        - words ending with *-ika*, *-yka*: ***ryt**mika* ("rhythmics"), ***mu**zyka* ("music")
        - some longer words (only in the nominative singular, and no derived words with native affixes): *uni**wer**sytet* ("university"), but *uniwersy**te**cki* ("relating to a university")
