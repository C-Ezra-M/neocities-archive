...
<Layout title="Polish Pokémon names | C.Ezra.M">
    <main class="fs-6">
        ...
        **Final obstruents are devoiced:** *dług* ("debt") → /dwuk/. Inflection explains the spelling: *dług-∅* → *dług-u*.
        ...
        |-|-|-|-|
        |*rdza*|(unknown)|*\*rъďa*|Bulgarian *ръжда́ rǎždá* ("rust")<br />Ukrainian *іржа́ iržá* ("rust")
        |*rtęć*|*rtęć*|*\*rьtǫtь*|Czech *rtuť* ("mercury, quicksilver")<br />Slovak *ortuť* ("mercury, quicksilver")
        |*źdźbło*|*śćbło*|*\*stьblo*|Ukrainian *стебло́ stebló* ("stalk, stem")<br />Serbo-Croatian *ста́бло stáblo* ("tree, trunk")
